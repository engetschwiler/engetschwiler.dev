<x-page title="Yves Engetschwiler, web & applications since 2002">
    <x-slot name="description">
        Yves Engetschwiler, web & applications since 2002 / Laravel / PHP / AlpineJS / Livewire / Tailwind CSS
    </x-slot>
    ...
    <div class="space-y-8 md:space-y-12">
        ...
        <section>
            ...
            <ul class="flex flex-wrap space-x-2 space-y-2 md:flex-nowrap md:space-y-0 md:space-x-4">
                ...
                <li><x-link href="https://www.linkedin.com/in/yves-engetschwiler/" target="_blank"><span>LinkedIn</span></x-link></li>
                <li><x-link href="https://pinkary.com/@interactive" target="_blank"><span>Pinkary</span></x-link></li>
                <li><x-link href="https://x.com/yvesdesign" target="_blank"><span>Twitter</span></x-link></li>
                <li><x-link href="https://instagram.com/derailleurch" target="_blank"><span>Instagram</span></x-link></li>
            </ul>
        </section>
    </div>
</x-page>
