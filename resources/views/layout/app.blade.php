...
<html lang="en">
    ...
    <body class="font-sans overflow-y-scroll bg-zinc-100 dark:bg-emerald-950">
        <div class="max-w-3xl mx-auto p-8 relative">
            <div class="absolute top-5 right-0" x-data="themeToggle()">
                <button @click="toggle()" class="p-2 hover:bg-zinc-200 dark:hover:bg-emerald-900 dark:text-zinc-200 rounded-full" :title="isDark ? 'Switch to light mode' : 'Switch to dark mode'">
